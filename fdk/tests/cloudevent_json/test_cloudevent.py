...
class TestCloudEventRequestParser(mixin.Mixin, testtools.TestCase):

    def setUp(self):
        self.format_def = constants.CLOUDEVENT
        self.loop = asyncio.new_event_loop()
        super(TestCloudEventRequestParser, self).setUp()

    def tearDown(self):
        self.loop.close()
        super(TestCloudEventRequestParser, self).tearDown()
    ...
    def test_parse_request_with_data(self):
        income_data = data.to_stream(
            data.cloudevent_request_with_body)
