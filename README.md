...
The Python FDK lets you write functions in Python 3.9/3.12.
...
```bash
fn init --runtime python3.12 test-function
```
...
pin your Python runtime version to `python`, `python3.9` or `python3.12`.
