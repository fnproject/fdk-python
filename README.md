...
The python FDK lets you write functions in python 3.11/3.12
...
```bash
fn init --runtime python3.11 test-function
```
...
pin your Python runtime version to `python`, `python3.11` or `python3.12`.
